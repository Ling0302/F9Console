					...
					<div class="row" id="box-widgets">
						...
						<section class="hidden-xs col-md-12 connectedSortable ui-sortable top-section">
							...
							<div class="box box-light <?php if (isset($boxStatuses['box-local-pools']) && !$boxStatuses['box-local-pools']) :?>collapsed-box<?php endif; ?>" id="box-local-pools">
								...
								<div class="box-footer">
									<h6><?php echo lang('app.legend') ?>: <strong>CS</strong> = <?php echo lang('app.current_shares') ?>, <strong>PS</strong> = <?php echo lang('app.previous_shares') ?>, <strong>CA</strong> = <?php echo lang('app.current_accepted') ?>, <strong>PA</strong> = <?php echo lang('app.previous_accepted') ?>, <strong>CR</strong> = <?php echo lang('app.current_rejected') ?>, <strong>PR</strong> = <?php echo lang('app.previous_rejected') ?></h6>
									<h6><strong><?php echo lang('app.current') ?></strong> <?php echo lang('app.current_explain') ?>, <strong><?php echo lang('app.previous') ?></strong> <?php echo lang('app.previous_explain') ?></h6>
								</div>
							</div><!-- /.local pools box -->
							<?php endif; ?>
